...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('hoi-thao/{slug}.html','PageController@serviceDetail')->name('serviceDetail');
    Route::get('tat-ca-hoi-thao.html','PageController@listService')->name('listService');
    Route::get('gioi-thieu-ve-the-sun.html','PageController@aboutUs')->name('aboutUs');  
    ...
    Route::get('tat-ca-chuong-trinh-dao-tao.html','ProductController@allProduct')->name('allProduct');
