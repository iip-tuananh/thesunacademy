      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">Thêm mới hoặc sửa sửa khóa học</p>
            ...
            <vs-table stripe :data="list" max-items="10" pagination>
              ...
              <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                  <vs-td ><vs-avatar size="large" :src="JSON.parse(tr.avatar)[0]"/></vs-td>
                  ...
                  <vs-td v-if="tr.date_start != null">{{tr.date_start}}</vs-td>
                  <vs-td v-if="tr.date_start == null">-----</vs-td>
                  <vs-td >
