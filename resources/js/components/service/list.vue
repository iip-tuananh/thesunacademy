              ...
              <vs-table stripe :data="list" max-items="10" pagination>
                ...
                <template slot-scope="{data}">
                  <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td v-if="tr.sku != null" :data="tr.sku">{{tr.sku}}</vs-td>
                    <vs-td v-if="tr.sku == null" :data="tr.sku">-----</vs-td>
                    <vs-td v-if="tr.date_start != null" :data="tr.date_start">{{tr.date_start}}</vs-td>
                    <vs-td v-if="tr.date_start == null" :data="tr.date_start">-----</vs-td>
                    <vs-td >
