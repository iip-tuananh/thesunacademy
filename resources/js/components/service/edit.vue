          ...
          <div class="card">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <ImageMulti v-model="objData.avatar" :title="'hoi-thao'"/> 
              </div>
              <div class="form-group">
                <label>Ảnh banner</label>
                <ImageMulti v-model="objData.image" :title="'hoi-thao'"/> 
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    addServices(){
      ...
      if(this.objData.image.length == 0) this.errors.push('Vui lòng chọn banner');
      ...
      if (this.errors.length > 0) {
        ...
        this.addService(this.objData).then(response => {
          ...
          this.$success('Thêm hội thảo thành công');
        }).catch(error => {
          this.loadings(false);
          this.$error('Thêm hội thảo thất bại');
        })
      }
    },
