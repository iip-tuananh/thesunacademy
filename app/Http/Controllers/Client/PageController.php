...
class PageController extends Controller
{
    ...
    public function aboutUs(){
        ...
        $data['pageContent'] = PageContent::where(['type'=>'ve-chung-toi', 'language'=>'vi', 'status'=>1])->first(['id','title','content', 'image', 'description','tamnhin', 'sumenh', 'trietly']);
    ...
    {
        $data['title_page'] = 'Tất cả hội thảo';
        $data['services'] = Services::where(['status'=>1])->orderBy('date_start', 'asc')->select()->paginate(12);
